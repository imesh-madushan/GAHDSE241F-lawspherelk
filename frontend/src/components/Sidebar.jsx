...
const Sidebar = ({ activeItem, setActiveItem, expanded, setExpanded }) => {
  ...
  const menuItems = {
    'OIC': [
      ...
      { id: 'reports', label: 'Reports', icon: <Summarize /> },      { id: 'officers', label: 'Officer Management', icon: <People /> },
    ...
    'Crime OIC': [
      ...
      { id: 'evidences', label: 'Evidence', icon: <Inventory2 /> },
      { id: 'crimeoffences', label: 'Crime Offences', icon: <Description /> },
      { id: 'criminals', label: 'Criminal Records', icon: <Fingerprint /> },      { id: 'officers', label: 'Officers', icon: <People /> },
